                    ...
                    <div class="col-md-12">
                        <div class="breadcrumb-content">
                            <ul class="nav">
                                ...
                                <li>وبلاگ (شبکه ای) - با نوار کناری راست</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-blog-post mb-30px blog-grid-post">
                                        <div class="blog-post-media">
                                            <div class="blog-image">
                                                <RouterLink to="/blog/single-left-sidebar"><img
                                        ...
                                        <div class="blog-post-content-inner mt-30px">
                                            <h4 class="blog-title"><RouterLink
                                                ...
                                                >لورم ایپسوم متن ساختگی با سادگی</RouterLink>
                                            </h4>
                                            <ul class="blog-page-meta">
                                                <li>
                                                    <RouterLink to="#"><i class="ion-person"></i>
                                                        ادمین
                                                    </RouterLink>
                                                </li>
                                                <li>
                                                    <RouterLink to="#"><i class="ion-calendar"></i>
                                                        24 بهمن
                                                        1401</RouterLink>
                                                </li>
                                            </ul>
                                ...
                                <div class="col-md-6">
                                    <div class="single-blog-post mb-30px blog-grid-post">
                                        <div class="blog-post-media">
                                            <div
                                                class="blog-gallery swiper-container slider-nav-style-1">
                                                <div class="blog-gallery swiper-wrapper">
                                                    <div class="gallery-item swiper-slide">
                                                        <RouterLink to="/blog/single-left-sidebar">
                                                            <img
                                ...
                                <div class="recent-post-widget">
                                    <div class="recent-single-post d-flex">
                                        ...
                                        <div class="media-side">
                                            <h5>
                                                <RouterLink to="/blog/single-left-sidebar">لورم
                                                    ایپسوم متن
