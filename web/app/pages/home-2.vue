                    ...
                    <div class="col-lg-3">
                        <div class="banner-area">
                            <div class="banner-wrapper mb-md-30px mb-lm-30px mb-sm-30px">
                                <RouterLink to="/shop/4-column"><img
                                        src="/assets/images/banner-image/9.jpg"
                                        alt=""
                                    /></RouterLink>
                            </div>
                            <div class="banner-wrapper mb-0px">
                                <RouterLink to="/shop/4-column"><img
                                        src="/assets/images/banner-image/10.jpg"
                                        alt=""
                                    /></RouterLink>
                            </div>
                        </div>
                            ...
                            <article class="list-product">
                                ...
                                <div class="add-to-link">
                                    <ul>
                                        ...
                                        <li>
                                            <RouterLink to="/wishlist"><i class="icon-heart"></i>
                                            </RouterLink>
                                        </li>
                                        <li>
                                            <RouterLink to="/compare"><i class="icon-shuffle"></i>
                                            </RouterLink>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-xs-12">
                        <div class="banner-wrapper">
                            <RouterLink to="/shop/4-column"><img
                                    src="/assets/images/banner-image/7.jpg"
                                    alt=""
                                /></RouterLink>
                        </div>
                    </div>
                    <div class="col-md-6 col-xs-12">
                        <div class="banner-wrapper">
                            <RouterLink to="/shop/4-column"><img
                                    src="/assets/images/banner-image/8.jpg"
                                    alt=""
                                /></RouterLink>
                        </div>
                    </div>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <RouterLink
                                                                ...
                                                                to="/wishlist"
                                                            ><i class="icon-heart"></i></RouterLink>
                                                        </li>
                                                        <li>
                                                            <RouterLink
                                                                title="مقایسه محصول"
                        ...
                        <div class="category-slider-item swiper-slide">
                            <div class="category-slider-bg ">
                                ...
                                <div class="category-discript">
                                    ...
                                    <ul>
                                        <li>
                                            <RouterLink to="#">زیر دسته یک</RouterLink>
                                        </li>
                                        <li>
                                            <RouterLink to="#">زیر دسته دو</RouterLink>
                                        </li>
                                        <li>
                                            <RouterLink to="#">زیر دسته سه</RouterLink>
                                        </li>
                                        <li>
                                            <RouterLink to="#">زیر دسته چهار</RouterLink>
                                        </li>
                                    </ul>
                                    <RouterLink
                                        to="/shop/4-column"
                                        class="view-all-btn"
                                    >مشاهده همه</RouterLink>
                                </div>
                            </div>
                        </div>
                        <div class="category-slider-item swiper-slide">
