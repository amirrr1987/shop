                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="product-details-img product-details-tab">
                            ...
                            <div
                                id="gallery"
                                class="product-dec-slider-2 swiper-container"
                            >
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a
                                            class="active"
                                            data-image="assets/images/product-image/22.jpg"
                                            data-zoom-image="assets/images/product-image/zoom/1.jpg"
                                        >
                                            <img
                                    ...
                                    <div class="swiper-slide">
                                        <a
                                            data-image="assets/images/product-image/21.jpg"
                                    ...
                                    <div class="swiper-slide">
                                        <a
                                            data-image="assets/images/product-image/23.jpg"
                                    ...
                                    <div class="swiper-slide">
                                        <a
                                            data-image="assets/images/product-image/6.jpg"
                        ...
                        <div class="product-details-content">
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <RouterLink to="#">نوع محصول یک</RouterLink>
                                            </td>
                                            <td><span class="amount">40.000 تومان</span></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="quantity d-flex">
                                            ...
                                            <td>
                                                <RouterLink to="#">نوع محصول دو</RouterLink>
                                            </td>
                                            <td><span class="amount">59.000 تومان</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="pro-details-wish-com">
                                <div class="pro-details-wishlist">
                                    <RouterLink to="#"><i class="icon-heart"></i>افزودن به لیست
                                        علاقه مندی ها</RouterLink>
                                </div>
                                <div class="pro-details-compare">
                                    <RouterLink to="#"><i class="icon-shuffle"></i>مقایسه محصول</RouterLink>
                                </div>
                            </div>
                            ...
                            <div class="pro-details-policy">
                                <ul>
                                    <li><img
                                            src="/assets/images/icons/policy.png"
                                            alt=""
                                        /><span>سیاست امنیتی : توضیحات مربوط به این ویژگی</span>
                                    </li>
                                    <li><img
                                            src="/assets/images/icons/policy-2.png"
                                            alt=""
                                        /><span>حمل و نقل : توضیحات مربوط به این ویژگی</span></li>
                                    <li><img
                                            src="/assets/images/icons/policy-3.png"
                                            alt=""
                                        /><span>ضمانت مرجوعی : توضیحات مربوط به این ویژگی</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        >
                            <div class="product-anotherinfo-wrapper">
                                <ul>
                                    ...
                                    <li><span>سایر اطلاعات</span>محصول دارای دفترچه راهنما می باشد.
                                    </li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <div class="single-review">
                                            ...
                                            <div class="review-content">
                                                <div class="review-top-wrap">
                                                    ...
                                                    <div class="review-left">
                                                        <RouterLink to="#">پاسخ دادن</RouterLink>
                                                    </div>
                                                </div>
                            ...
                            <article class="list-product">
                                ...
                                <div class="product-decs">
                                    <RouterLink
                                        class="inner-link"
                                        to="/shop/4-column"
                                    ><span>عنوان محصول</span></RouterLink>
                                    <h2>
                                        <RouterLink
                                            to="/product"
                                            class="product-link"
                                        >توضیحات مربوط به محصول</RouterLink>
                                    </h2>
                                    <div class="rating-product">
                                        <i class="ion-android-star"></i>
                                        <i class="ion-android-star"></i>
                                ...
                                <div class="add-to-link">
                                    <ul>
                                        <li class="cart"><a
                                            ...
                                            >خرید</a></li>
                                        <li>
                                            <RouterLink to="/wishlist"><i
                                                    class="icon-heart"></i></RouterLink>
                                        </li>
                                        <li>
                                            <RouterLink to="/compare"><i
                                                    class="icon-shuffle"></i></RouterLink>
                                        </li>
                                    </ul>
                                </div>
                            </article>
