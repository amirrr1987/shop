...
<!-- Mirrored from htmldemo.net/rozer/rozer/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2023 11:15:05 GMT -->
<head>
        <meta charset="utf-8" />
                            ...
                            <div class="header-horizontal-menu">
                                <ul class="menu-content">
                                    <li class="active menu-dropdown">
                                        <a href="#"> <i class="icon icon-home"></i> Home <i class="ion-ios-arrow-down"></i></a>
                                    ...
                                    <li class="menu-dropdown">
                                        <a href="#"><i class="icon icon-bag"></i> Shop <i class="ion-ios-arrow-down"></i></a>
                                        <ul class="mega-menu-wrap left-0px">
                                            <li>
                                                <ul>
                                    ...
                                    <li class="menu-dropdown">
                                        <a href="#"> <i class="icon icon-doc"></i>Pages <i class="ion-ios-arrow-down"></i></a>
                                        <ul class="main-sub-menu">
                                    ...
                                    <li class="menu-dropdown">
                                        <a href="#"> <i class="icon icon-notebook"></i>Blog <i class="ion-ios-arrow-down"></i></a>
                                        <ul class="main-sub-menu">
                                    ...
                                    <li><a href="contact.html"><i class="icon icon-support"></i> contact Us</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="slider-area slider-height-3">
            <div class="hero-slider swiper-container">
                <div class="swiper-wrapper">
                    <!-- Single Slider  -->
                    <div class="swiper-slide bg-img d-flex" style="background-image: url(assets/images/slider-image/sample-5.jpg);">
                    ...
                    <!-- Single Slider  -->
                    <div class="swiper-slide bg-img d-flex" style="background-image: url(assets/images/slider-image/sample-6.jpg);">
                        <div class="container align-self-center">
                            <div class="slider-content-1 slider-animated-1 text-start pl-60px">
...
<!-- Mirrored from htmldemo.net/rozer/rozer/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2023 11:15:09 GMT -->
</html>
