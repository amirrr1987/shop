...
<!-- Mirrored from htmldemo.net/rozer/rozer/compare.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2023 11:15:30 GMT -->
<head>
        <meta charset="utf-8" />
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="product-image-title">
                                                    <a href="#" class="image"><img class="img-responsive" src="assets/images/product-image/19.jpg" alt="Compare Product" /></a>
                                                    <a href="#" class="category">Camera</a>
                                                    <a href="#" class="title">Zeon Zen 4 Pro</a>
                                                </td>
                                                <td class="product-image-title">
                                                    <a href="#" class="image"><img class="img-responsive" src="assets/images/product-image/24.jpg" alt="Compare Product" /></a>
                                                    <a href="#" class="category">Doren</a>
                                                    <a href="#" class="title">Aquet Doren D 420</a>
                                                </td>
                                                <td class="product-image-title">
                                                    <a href="#" class="image"><img class="img-responsive" src="assets/images/product-image/10.jpg" alt="Compare Product" /></a>
